...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='LDM4TS')
    ...
    # model define
    parser.add_argument('--grayscale', default=True, help="save image")
    parser.add_argument('--freeze_ldm', default=True, help="freeze ldm")
    parser.add_argument('--save_images', default=False, action="store_true", help="save image")
    parser.add_argument('--image_size', type=int, default=64, help='image size')
    parser.add_argument('--patch_size', type=int, default=16, help='patch size')
    parser.add_argument('--num_timesteps', type=int, default=1000, help='training time step of diffusion')
    ...
    parser.add_argument('--ldm_dim', type=int, default=512, help='hidden dimension of ldm')
    parser.add_argument('--gate_dim', type=int, default=256, help='hidden dimension of ldm')
    ...
    parser.add_argument('--d_ff', type=int, default=768, help='dimension of fcn') # for each llm
